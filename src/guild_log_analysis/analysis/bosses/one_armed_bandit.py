...
class OneArmedBanditAnalysis(BossAnalysisBase):
    ...
    def _generate_interrupts_plot(
        ...
        previous_fight_count: int,
    ) -> None:
        """Generate plot for Overload! interrupts."""
        current_data, previous_dict = self.find_analysis_data("Overload! Interrupts", "interrupts", "player_name")
    ...
    def _generate_boss_damage_plot(
        ...
        current_dmg_data, previous_dmg_dict = self.find_analysis_data("Boss Damage", "damage_to_boss", "player_name")
