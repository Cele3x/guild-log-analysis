...
class TestAPIIntegration:
    ...
    def test_full_analysis_with_mocked_api(self, mock_make_request, sample_api_response, 
                                          sample_player_details_response, sample_actors_response,
                                          sample_damage_response, sample_interrupt_events):
